...
<head>
    ...
    <style>
        ...
        /* AJOUTÉ : Empêche les petits décalages horizontaux sur mobile */
...
<body class="antialiased">
    ...
    <?php if($current_cat === 'Tutti'): ?>
        <section class="relative h-screen flex items-center bg-zinc-950 overflow-hidden">
            <div class="absolute right-0 top-0 w-full md:w-2/3 h-full opacity-40 grayscale hover:grayscale-0 transition-all duration-[2s]">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-6 w-full">
                <div class="max-w-2xl">
                    ...
                    <h1 id="hero-text" class="text-white text-5xl sm:text-6xl md:text-9xl font-extrabold leading-[0.9] tracking-tighter mb-8">
                    ...
                    <div class="mt-12 flex flex-col sm:flex-row items-center gap-8">
                        <a href="#selection" class="w-full sm:w-auto text-center bg-[#2D5A27] text-white px-10 py-5 rounded-sm font-bold uppercase text-[10px] tracking-widest hover:bg-white hover:text-black transition-all">
                            Inizia l'Esperienza
                        </a>
                    </div>
                </div>
            ...
            <div class="hidden lg:block absolute left-10 bottom-10 [writing-mode:vertical-lr] text-white font-black text-9xl uppercase opacity-5 select-none">
                VOLANTE
            </div>
        </section>

        <div class="py-10 bg-white border-b border-gray-100">
            <div class="flex whitespace-nowrap animate-marquee items-center opacity-30 grayscale text-sm md:text-xl">
                <div class="flex gap-10 md:gap-20 pr-10 md:pr-20 items-center font-bold uppercase tracking-tighter">
    ...
    <main id="selection" class="max-w-7xl mx-auto px-6 py-12 md:py-24">
        <div class="mb-10 md:mb-16 reveal">
            <h2 class="text-3xl md:text-5xl font-extrabold uppercase tracking-tighter">
                <?= $titolo_sezione ?>
            </h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
            ...
            <a href="product.php?id=<?= $p['id'] ?>" class="group reveal">
                <div class="bg-gray-50 p-6 md:p-8 transition-all duration-500 group-hover:bg-white group-hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] rounded-2xl">
                    <div class="aspect-square mb-6 md:mb-8 overflow-hidden flex items-center justify-center">
                    ...
                    <div class="border-t border-gray-100 pt-6">
                        ...
                        <h3 class="text-lg md:text-xl font-bold uppercase tracking-tight"><?= $p['nome_modello'] ?></h3>
                        <p class="mt-4 text-gray-400 font-light italic text-sm md:text-base">€<?= number_format($p['prezzo'], 0, '', '.') ?></p>
                    </div>
                </div>
            </a>
            <?php endforeach; ?>
    ...
    <section class="bg-zinc-900 py-20 md:py-32 text-white relative overflow-hidden">
        <div class="max-w-4xl mx-auto px-6 text-center relative z-10">
            <h2 class="text-[#2D5A27] text-[10px] font-bold uppercase tracking-[0.6em] mb-8 md:mb-12 italic">Il Nostro Manifesto</h2>
            <p class="editorial-font text-2xl md:text-5xl leading-tight">
        ...
        <div class="absolute top-0 right-0 text-white/[0.02] text-[10rem] md:text-[20rem] font-black -mr-16 md:-mr-32 -mt-16 md:-mt-32 select-none italic">ELITE</div>
    </section>

    <section class="bg-black py-20 md:py-32 overflow-hidden">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-16 md:mb-20 reveal">
                <h2 class="text-white text-3xl md:text-5xl font-extrabold uppercase tracking-tighter">
            ...
            <div class="relative">
                <div id="testimonial-slider" class="testimonial-wrapper gap-6 md:gap-8">
                    <?php 
                    $testimonials = [
                    ...
                    <div class="testimonial-item min-w-full md:min-w-[calc(33.333%-1.5rem)]">
                        <div class="bg-zinc-900/40 border border-zinc-800 p-8 md:p-10 rounded-3xl h-full flex flex-col items-center text-center group">
                            <div class="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden mb-6 md:mb-8 border-2 border-[#2D5A27] p-1">
                            ...
                            <div class="flex gap-1 mb-4 md:mb-6 text-yellow-500">
                                <?php for($i=0; $i<5; $i++): ?>
                            ...
                            <p class="text-zinc-400 font-light leading-relaxed mb-6 md:mb-8 italic text-sm md:text-base">"<?= $t['text'] ?>"</p>
    ...
    <script>
        ...
        window.addEventListener('scroll', () => {
            if(window.innerWidth > 1024) { // Parallaxe uniquement sur PC pour économiser la batterie mobile
